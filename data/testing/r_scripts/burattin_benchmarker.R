...
knoababtimings <- read.csv(file = 'C:/Users/Sam/Documents/Repositories/Codebases/knobab/data/testing/results/knobab_burattin_benchmark.csv')
...
ggplot( aes(x=model_filename, y=execution_time, fill=atomization_conf)) +
