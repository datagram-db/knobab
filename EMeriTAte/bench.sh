...
do
   ...
   do
      ...
      do
        ...
        /home/giacomo/projects/knobab2_loggen/EMeriTAte/venv/bin/python /home/giacomo/projects/knobab2_loggen/EMeriTAte/other_processing_steps.py $patho "class" 9 "time"  $s $i $j 2>> errors.log
        if [ $? -eq 0 ]
        then
