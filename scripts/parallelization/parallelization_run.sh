...
for val in "${StringArray[@]}"; do
	./parall/knobab-v1.0 -n -o -q 5 -e $ms --topN=5 --topNTemplate=$val --xes=/home/giacomo/projects/knobab/data/testing/bpic_2011/data/original/log.xes  --maxsat=scripts/maxsat_pipeline.yaml --csv=parall.csv
	for proc in "${ProcArray[@]}"; do
		for ms in "${SchedArray[@]}"; do
			echo "$ms $val $proc"
			echo ./parall/knobab-v1.0 -n -o -q 5 -e $ms --topN=5 --topNTemplate=$val --xes=/home/giacomo/projects/knobab/data/testing/bpic_2011/data/original/log.xes  --maxsat=$proc --csv=parall.csv
