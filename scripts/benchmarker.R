...
timings <- read.csv(file = 'C:/Users/Sam/Documents/Repositories/Codebases/knobab/benchmark.csv')
...
sqltimings <- read.csv(file = 'C:/Users/Sam/Documents/Repositories/Codebases/knobab/sql_benchmark.csv')
...
ggplot(sqlsuccessdf, aes(x=n_traces, y=sql_execution_time), group=query_type) +
  ...
  facet_wrap( ~ model_filename, nrow=2, ncol=4, scales="free") +
