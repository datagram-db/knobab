...
double SB_MotifThree_quantile_hh(const double y[], const int size)
{
    ...
    for (int i = 0; i < alphabet_size; i++) {
        if (sizes_r1[i] != 0 && r1[i][sizes_r1[i] - 1] == size - 1) {
            ...
            int* tmp_ar = static_cast<int *>(malloc(sizes_r1[i] * sizeof(tmp_ar)));
    ...
    */
    int*** r2 = static_cast<int ***>(malloc(alphabet_size * sizeof(**r2)));
    int** sizes_r2 = static_cast<int **>(malloc(alphabet_size * sizeof(*sizes_r2)));
    double** out2 = (double ** )malloc(alphabet_size * sizeof(*out2));
    

    // allocate separately
    for (int i = 0; i < alphabet_size; i++) {
        r2[i] = static_cast<int **>(malloc(alphabet_size * sizeof(*r2[i])));
        sizes_r2[i] = static_cast<int *>(malloc(alphabet_size * sizeof(*sizes_r2[i])));
        //out2[i] = malloc(alphabet_size * sizeof(out2[i]));
        out2[i] = static_cast<double *>(malloc(alphabet_size * sizeof(**out2)));
        for (int j = 0; j < alphabet_size; j++) {
            r2[i][j] = static_cast<int *>(malloc(size * sizeof(*r2[i][j])));
        }
    }
...
double * sb_motifthree(const double y[], int size, const char how[])
{
    ...
    // words of length 1
    array_size = alphabet_size;
    int ** r1 = static_cast<int **>(malloc(array_size * sizeof(*r1)));
    int * sizes_r1 = static_cast<int *>(malloc(array_size * sizeof(sizes_r1)));
    double * out1 = (double * )malloc(array_size * sizeof(out1));
    for (i = 0; i < array_size; i++) {
        r1[i] = static_cast<int *>(malloc(size * sizeof(r1[i]))); // probably can be rewritten
        // using selfresizing array for memory efficiency. Time complexity
        // should be comparable due to ammotization.
        r_idx = 0;
        sizes_r1[i] = 0;
    ...
    for (i = 0; i < alphabet_size; i++) {
        if (sizes_r1[i] != 0 && r1[i][sizes_r1[i] - 1] == size - 1) {
            tmp_ar = static_cast<int *>(malloc((sizes_r1[i] - 1) * sizeof(tmp_ar)));
            subset(r1[i], tmp_ar, 0, sizes_r1[i]);
            memcpy(r1[i], tmp_ar, (sizes_r1[i] - 1) * sizeof(tmp_ar));
            sizes_r1[i]--;
        }
    ...
    int *** r2 = static_cast<int ***>(malloc(array_size * sizeof(**r2)));
    int ** sizes_r2 = static_cast<int **>(malloc(array_size * sizeof(*sizes_r2)));
    double ** out2 = static_cast<double **>(malloc(array_size * sizeof(*out2)));
    for (i = 0; i < alphabet_size; i++) {
        r2[i] = static_cast<int **>(malloc(alphabet_size * sizeof(r2[i])));
        sizes_r2[i] = static_cast<int *>(malloc(alphabet_size * sizeof(sizes_r2[i])));
        out2[i] = static_cast<double *>(malloc(alphabet_size * sizeof(out2[i])));
    ...
    int **** r3 = static_cast<int ****>(malloc(array_size * sizeof(***r3)));
    int *** sizes_r3 = static_cast<int ***>(malloc(array_size * sizeof(**sizes_r3)));
    double *** out3 = static_cast<double ***>(malloc(array_size * sizeof(**out3)));
    for (i = 0; i < alphabet_size; i++) {
        r3[i] = static_cast<int ***>(malloc(alphabet_size * sizeof(r3[i])));
        sizes_r3[i] = static_cast<int **>(malloc(alphabet_size * sizeof(sizes_r3[i])));
        out3[i] = static_cast<double **>(malloc(alphabet_size * sizeof(out3[i])));
        for (j = 0; j < alphabet_size; j++) {
            r3[i][j] = static_cast<int **>(malloc(alphabet_size * sizeof(r3[i][j])));
            sizes_r3[i][j] = static_cast<int *>(malloc(alphabet_size * sizeof(sizes_r3[i][j])));
            out3[i][j] = static_cast<double *>(malloc(alphabet_size * sizeof(out3[i][j])));
            for (k = 0; k < alphabet_size; k++) {
                r3[i][j][k] = static_cast<int *>(malloc(size * sizeof(r3[i][j][k])));
                sizes_r3[i][j][k] = 0;
                dynamic_idx = 0;
    ...
    int ***** r4 = static_cast<int *****>(malloc(array_size * sizeof(****r4)));
    ...
    int **** sizes_r4 = static_cast<int ****>(malloc(array_size * sizeof(***sizes_r3)));
    double **** out4 = static_cast<double ****>(malloc(array_size * sizeof(***out4)));
    for (i = 0; i < alphabet_size; i++) {
        r4[i] = static_cast<int ****>(malloc(alphabet_size * sizeof(r4[i])));
        sizes_r4[i] = static_cast<int ***>(malloc(alphabet_size * sizeof(sizes_r4[i])));
        out4[i] = static_cast<double ***>(malloc(alphabet_size * sizeof(out4[i])));
        for (j = 0; j < alphabet_size; j++) {
            r4[i][j] = static_cast<int ***>(malloc(alphabet_size * sizeof(r4[i][j])));
            sizes_r4[i][j] = static_cast<int **>(malloc(alphabet_size * sizeof(sizes_r4[i][j])));
            out4[i][j] = static_cast<double **>(malloc(alphabet_size * sizeof(out4[i][j])));
            for (k = 0; k < alphabet_size; k++) {
                r4[i][j][k] = static_cast<int **>(malloc(alphabet_size * sizeof(r4[i][j][k])));
                sizes_r4[i][j][k] = static_cast<int *>(malloc(alphabet_size * sizeof(sizes_r4[i][j][k])));
                out4[i][j][k] = static_cast<double *>(malloc(alphabet_size * sizeof(out4[i][j][k])));
                for (l = 0; l < alphabet_size; l++) {
                    r4[i][j][k][l] = static_cast<int *>(malloc(size * sizeof(r4[i][j][k][l])));
                    sizes_r4[i][j][k][l] = 0;
                    dynamic_idx = 0;
