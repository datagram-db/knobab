...
struct AttributeTable {
    ...
    struct disjunctive_range_query_result {
         ...
         */
        std::unordered_map<const record*, double> approx_solution;
     ...
     * @return
     */
    range_query_result range_query(const DataPredicate &prop, ssize_t act = -1, double maximumApprox = 0.0, const double c = 2.0) const;
