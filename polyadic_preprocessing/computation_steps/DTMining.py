...
from original_paper.medical_analysis import performMiningOverAnalysedLog
from original_paper.parsing_medical_data import asFinalLog, exploseTimeVariations
