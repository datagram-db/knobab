...
const std::string file_path = "benchmarking/mdpi_22/data/results/custom_operators.csv";
...
void test_aAndFutureb(const Environment& environment){
    ...
    write_to_file(environment, "And_Future", "variant_2", r_aAndfb_time.count());
    ...
    write_to_file(environment, "And_Future", "variant_1", r_aAndfb_old_time.count());
...
void test_aAndGloballyb(const Environment& environment){
    ...
    write_to_file(environment, "And_Globally", "variant_2", r_a_and_globally_b_ut_time.count());
    ...
    write_to_file(environment, "And_Globally", "variant_1", r_a_and_globally_b_ut_time2.count());
...
int main(){
    ...
    for (const auto& dirEntry : std::filesystem::recursive_directory_iterator("benchmarking/mdpi_22/data/synthetic/logs")){
