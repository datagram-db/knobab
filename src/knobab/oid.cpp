...
oid &oid::operator=(const oid &x) { id.data = x.id.data; return *this; }
oid::oid(const oid &x) { id.data = x.id.data; }
bool oid::operator<(const oid &rhs) const { return id.data < rhs.id.data;  }
